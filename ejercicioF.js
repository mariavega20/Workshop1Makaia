...
const primerDigitoPasaporte = prompt("Ingrese el primer digito de su pasaporte");

const turistaNacional =  primerDigitoPasaporte === "A";
console.log("Respuesta turista nacional:  " + turistaNacional);

const turistaInternacional = !turistaNacional;
console.log("Respuesta turista internacional:  " + turistaInternacional);
